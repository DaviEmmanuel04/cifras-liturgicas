    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-[#e4ded0] p-8 h-fit">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">Nova Cifra</h1>
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full shadow-2xl border border-gray-150 overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="px-6 py-4 bg-gray-50 border-b border-gray-100 flex items-center justify-between">
              ...
              <button 
                ...
                className="text-gray-400 hover:text-gray-650 p-1 hover:bg-gray-100 rounded-full transition-colors cursor-pointer"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
