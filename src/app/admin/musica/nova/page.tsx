    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-serif text-2xl font-bold text-gray-900">Nova Música</h1>
            <p className="text-sm text-gray-500">Adicione um novo canto ao acervo litúrgico</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                placeholder="Ex: Te Amarei, Senhor"
              />
            </div>
